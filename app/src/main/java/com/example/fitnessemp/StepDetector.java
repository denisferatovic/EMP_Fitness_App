...
public class StepDetector {
    ...
    public String toString() {
        return "StepDetector{" +
                "accelRingCounter=" + accelRingCounter +
                ", accelRingX=" + Arrays.toString(accelRingX) +
                ", accelRingY=" + Arrays.toString(accelRingY) +
                ", accelRingZ=" + Arrays.toString(accelRingZ) +
                ", velRingCounter=" + velRingCounter +
                ", velRing=" + Arrays.toString(velRing) +
                ", lastStepTimeNs=" + lastStepTimeNs +
                ", oldVelocityEstimate=" + oldVelocityEstimate +
                ", listener=" + listener +
                '}';
    }
}
